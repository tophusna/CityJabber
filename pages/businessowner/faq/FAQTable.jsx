...
const FAQTable = () => {
  ...
  console.log('businessIfnormation===>', businessInfo)
  ...
  const getFAQInPage = async (page) => {
    const res = await getFAQs(page, businessInfo.BusinessId)
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <FAQEditModal dataSource={FAQs && FAQs[selectedFAQId]} closeModal={handleFAQClose} update={handleTagClick} current={currentPage} businessId={businessInfo.BusinessId && businessInfo.BusinessId} />
        </Modal.Body>
