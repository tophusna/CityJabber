...
import { createSponsorBusiness, updateSponsorBusiness } from "../../../../services/admin/business";
...
const BusinessUpdateModal = (props) => {
  ...
  useEffect(() => {
    if (business) {
      ...
      contactRef.current.value = business.ContactName
      addressRef.current.value = business.Address
      phoneRef.current.value = business.Phone 
    }
  }, [])
  ...
  const updateBusinessInfo = async (e) => {
    ...
    if (business) {
      ...
      const res = await updateSponsorBusiness(formData)
      if (res.success) {
      ...
      const res = await createSponsorBusiness(formData)
      if (res.success) {
        toast.success(res.message);
        props.update(props.current)
      }
        ...
        <div className="row y-gap-30 items-center">
          <div className="border-top-light" />
            ...
            <div className="d-flex flex-column justify-content-center  align-items-center">
              ...
              <div className="col-md-6">
                <div className="form-input ">
                  <input ref={contactRef} type="text" />
                  <label className="lh-1 text-16 text-light-1">
                    Sponsor Name
                  </label>
                </div>
            ...
            <div className="d-inline-block pt-30">
              ...
              >
                {business ? 'Update Sponsor Business' : 'Create Sponsor Business' } <div className="icon-arrow-top-right ml-15" />
              </button>
            </div>
          </form >
          <ToastContainer />
